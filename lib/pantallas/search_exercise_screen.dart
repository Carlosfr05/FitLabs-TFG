              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      itemExercise(exerciseList[index]),
                ),
              ),
            ],
          );
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: AppColors.dimmedColor.withValues(alpha: 0.3),
                      ),
                    ),
                    child: Row(
    ...
    return GestureDetector(
      onTap: () async {
        ...
        final configurado = await Navigator.push<ConfiguredExercise>(
          ...
          context,
          MaterialPageRoute(
            builder: (_) => ExerciseConfigScreen(exercise: item),
          ),
        );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColors.dimmedColor.withValues(alpha: 0.2),
