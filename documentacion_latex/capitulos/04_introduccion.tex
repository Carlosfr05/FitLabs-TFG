...
\begin{quote}
\textit{FitLabs es una aplicación móvil multiplataforma desarrollada con Flutter y respaldada por Supabase, diseñada para ayudar a entrenadores personales a gestionar su actividad profesional. La aplicación ofrece herramientas para la gestión de clientes, la creación de rutinas de entrenamiento personalizadas, la planificación mediante un calendario integrado, la mensajería en tiempo real entre entrenadores y clientes y el seguimiento del progreso de los usuarios. El proyecto sigue una metodología de desarrollo estructurada, con una arquitectura modular en Flutter, una base de datos relacional PostgreSQL protegida mediante políticas de Row Level Security y una interfaz limpia, orientada al entrenador, diseñada en Figma. Durante el desarrollo se evaluó y prototipó parcialmente una API externa de ejercicios, pero la versión final utiliza un catálogo local para evitar problemas de dependencia y licencias. El resultado es un MVP plenamente operativo que cubre las necesidades básicas de un entrenador personal en una única plataforma unificada.}
\end{quote}
...
\begin{enumerate}
  ...
  \item \textbf{OF-04} -- Diseñar e implementar el módulo de \textit{Crear Rutina}, incluyendo la búsqueda y selección de ejercicios con un catálogo local tras valorar una API externa de ejercicios.
